...
//         // ... fill in the updated product data here
//       };
...
//           "http://localhost:8000/api/product"
//         );
//         // console.log("Response:", productResponse.data.data);
...
//         <button className="flex items-center bg-green-500 text-white font-bold py-2 px-4 rounded">
...
//             key={index}
//             onClick={() =>
//               paginate(typeof page === "number" ? page : currentPage)
//             }
