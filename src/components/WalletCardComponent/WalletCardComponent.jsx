...
// import { FaUser, FaShoppingCart, FaMoneyBillWave, FaExchangeAlt } from "react-icons/fa";

// const WalletCardComponent = () => {
//   const [searchTerm, setSearchTerm] = useState("");

//   const transactions = [
//     { id: 1, description: "Food Order", amount: -20.00 },
//     { id: 2, description: "Wallet Top-Up", amount: 100.00 },
//   ];

//   const totalOrders = transactions.filter(transaction => transaction.description.toLowerCase().includes("order")).length;
//   const totalRevenue = transactions.reduce((acc, transaction) => acc + transaction.amount, 0);

//   // Lọc giao dịch dựa trên từ khóa tìm kiếm
...
//           <p className="text-3xl font-bold text-blue-600">286,776 VND</p>
//         </div>
//         <div className="flex flex-col">
...
//           <p className="text-lg font-bold">Lai Van Chung</p>
//         </div>
//         <div className="flex flex-col">
//           <span className="text-gray-600">Ngày mở tài khoản</span>
//           <p className="text-lg font-bold">26/05/2023</p>
//         </div>
//         <div className="flex flex-col">
//           <span className="text-gray-600">Chi nhánh mở tài khoản</span>
//           <p className="text-lg font-bold">TPBANK DIGITAL 3</p>
//         </div>
//         <div className="flex flex-col">
//           <span className="text-gray-600">Số tài khoản</span>
//           <p className="text-lg font-bold">2831 6072 002</p>
//         </div>
//       </div>
...
const WalletCardComponent = () => {
  ...
  const totalOrders = transactions.filter((transaction) =>
    transaction.description.toLowerCase().includes("order")
  ).length;
    ...
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6 my-6">
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-green-100 p-4 rounded-lg shadow flex items-center">
          ...
          <div>
            <h4 className="font-semibold">Tổng doanh thu</h4>
            <p className="text-2xl font-bold text-green-600">{`+ $${totalRevenue.toFixed(
              2
            )}`}</p>
          </div>
        </div>
