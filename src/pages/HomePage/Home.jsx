  ...
  return (
    <div className="bg-gradient-to-r from-purple-500 to-indigo-500 min-h-screen flex flex-col">
      ...
      <header className="flex justify-between items-center p-6 bg-white shadow-md">
        <div className="text-2xl font-bold">FTOP E-Wallet</div>
      ...
      <main className="flex-1 flex flex-col lg:flex-row justify-between items-center px-6 lg:px-24 py-12">
        ...
        <div className="text-white max-w-lg space-y-6">
          <h1 className="text-5xl font-bold">FTOP E-Wallet</h1>
          <p className="text-lg">
            FTOP E-Wallet is a digital wallet designed specifically for FPT students. With FTOP E-Wallet, you can easily manage your finances, pay tuition fees, and much more.
          </p>
          <a
            href="#learn-more"
